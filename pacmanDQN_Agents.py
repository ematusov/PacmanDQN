...
class PacmanDQN(game.Agent):
    ...
    def final(self, state):
        ...
        log_file.write('recorded times: {}'.format(self.recorded_times))
        log_file.write('number of steps: {}'.format(self.number_of_steps))
        log_file.write('winning outcomes: {}'.format(self.win_percentages))
        sys.stdout.flush()
